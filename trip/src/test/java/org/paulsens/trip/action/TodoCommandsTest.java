...
public class TodoCommandsTest {
    ...
    public void testGetTodos() {
        ...
        final DataId dataId = todo2.getDataId();
    ...
    public void creatingSavingGettingTodoStatusWorks() {
        ...
        final TodoStatus todoStatus = todoCommands.getOrCreateTodoStatus(todo, pid);
    ...
    private void setTodoStatusForUser(
        ...
        if (todo == null) {
            notNullTodo = todoCommands.createTodo(tripId);
            assertTrue(todoCommands.saveTodo(notNullTodo));                     // Create the Todo
        } else {
            notNullTodo = todo;
        }
        final TodoStatus todoStatus = todoCommands.getOrCreateTodoStatus(notNullTodo, pid);
