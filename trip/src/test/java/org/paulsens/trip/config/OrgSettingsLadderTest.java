...
public class OrgSettingsLadderTest {
    ...
    public void theRegistryMarksExactlyTheAgreedSet() {
        ...
        Assert.assertEquals(names, List.of("site.org.name", "site.analytics.id", "home.photos.windowDays",
                "home.photos.minCount", "home.countdown.soonDays", "chat.reactions.palette",
                "chat.background.colors", "chat.background.image", "reg.allowEdits"),
